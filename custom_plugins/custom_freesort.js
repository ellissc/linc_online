var FreeSortPlugin = (function (jspsych) {
  "use strict";
    ...
    trial(display_element, trial) {
      ...
      for (let i = 0; i < stimuli.length; i++) {
        ...
        display_element.querySelector("#jspsych-free-sort-arena").innerHTML +=
          // "<img " + 'src="' + stimuli[i] + '" ' + 'data-src="' + stimuli[i] + '" ' +
          // 'class="jspsych-free-sort-draggable" ' + 'draggable="false" ' + 
          // 'id="jspsych-free-sort-draggable-' + i + '" ' + 
          // 'style="position: absolute; cursor: move; width:' + trial.stim_width + "px; height:" +
          // trial.stim_height + "px; top:" + coords.y + "px; left:" + coords.x + 'px;">' + "</img>";
          '<div ' +
          'class="jspsych-free-sort-draggable" ' +
          'id="jspsych-free-sort-draggable-' + i + '" ' +
          'style="position: absolute; cursor: move; width:' + trial.stim_width + 'px; height:' +
          trial.stim_height + 'px; top:' + coords.y + 'px; left:' + coords.x + 'px;">' +
          stimuli[i] +
          '</div>';
